...
resource "aws_iam_role" "jobe_task_assume" {
  name = "${local.app_name}-jobe_task_assume"
...
resource "aws_iam_role_policy" "jobe_task_assume" {
  name = "${local.app_name}-jobe_task_assume"
  role = aws_iam_role.jobe_task_assume.id
